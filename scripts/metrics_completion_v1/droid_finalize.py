...
from droid_common import (ROOT, REPORT, REG, METRICS, POLICY, atomic_json, module, now,
...
def finalize():
    ...
    with (REPORT / ".finalize.lock").open("a") as lock:
        ...
        final = {"schema": "droid_complementary_metrics_v1_finalization", "status": "passed", "completed_utc": now(),
            "registration_sha256": sha(REG), "scope": POLICY["scope"], "policy": POLICY,
