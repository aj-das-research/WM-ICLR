...
| Spatial architecture revision | Complete: 15 full 30-epoch runs, 15 exact offline reloads, 16 paired comparisons; native h10 +5.30% vs autoregression and +3.55% vs anchoring | Independent numerical/public-payload audit passed; 9 favorable intervals, 7 inconclusive, 2 unfavorable point estimates. Context adds no clear benefit. Six-run component follow-up is being implemented and independently reviewed; no new GPU jobs as of 06:42 UTC |
