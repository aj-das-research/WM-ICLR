...
| Spatial architecture revision | Implemented and frozen: 4×4 tokens, observation-anchored transport plus bounded innovation; 49 tests and independent review passed | Cache/resource gate passed; 15 full runs executing across three seed chains, with finalizer200230 and qualitative replay200236 queued. The two verified ws-ia GPUs remain active. Both gpu-partition attempts collided with existing GPU-memory use; unchanged seed2 jobs200266–200270 now use two lanes on ws-l1-002 and ws-l5-004 after the earlier seed chains finish. Finalizer200271 now gates qualitative200236, release200254 and complete manuscript tables200278 (13 reporting tests passed). Measured projection2.11GPU-hours excludes execution overhead |
...
- [42-model simulation release](https://github.com/aj-das-research/WM-ICLR/releases/tag/simulator-development-v1): verified public downloads and exact offline cached/image prediction parity; **102 public predictors overall**
