...
| Matched h10-training control | Complete: 12 full30-epoch runs /60 evaluations /20 paired contrasts; all select epoch1. Ours h10 endpoint +2.772% vs h5-trained and +0.405% vs equally h10-trained Framewise | Paper tables generated by200206 and independently reviewed; all12predictors publicly released with exact offline parity |
...
| Spatial architecture revision | Complete: 15 full 30-epoch runs, 15 exact offline reloads, 16 paired comparisons; native h10 +5.30% vs autoregression and +3.55% vs anchoring | Independent numerical/public-payload audit passed; 9 favorable intervals, 7 inconclusive, 2 unfavorable point estimates. Context adds no clear benefit. Six-run component follow-up complete: all30 epochs, six exact offline predictors, all20 effects finalized by200449. Native mixing effects favorable; native bounding and all interactions inconclusive. Version comparison, task, architecture and qualitative figures are integrated in the 67-page draft; all six follow-up runs complete at07:19UTC |
| Additional real benchmark | Public IWS manipulation download and metadata audit complete; 3,489 train / 60 validation recordings. Full PushT feature cache validated: 600 recordings /119,887 frames (480 train/120 internal development) | Box/Rope full caches running as200465/200466 after independent84-test review. Single-observation predictor protocol designed; training/evaluation not yet run. Official validation payloads remain untouched. Retain upstream horizon-index ambiguity and metadata discrepancies. RLA-WM reproduction requires authorized DINOv3-L access and compatibility repair |
...
- [42-model simulation release](https://github.com/aj-das-research/WM-ICLR/releases/tag/simulator-development-v1): verified public downloads and exact offline cached/image prediction parity; **117 public predictors overall**

- [15-model spatial release](https://github.com/aj-das-research/WM-ICLR/releases/tag/spatial-world-models-v1): all 217 archive payloads independently hash-verified.
- [12-model ten-step development release](https://github.com/aj-das-research/WM-ICLR/releases/tag/horizon10-development-v1): all checkpoints and public assets verified.
