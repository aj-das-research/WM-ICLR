...
| Spatial architecture revision | Complete: 15 full 30-epoch runs, 15 exact offline reloads, 16 paired comparisons; native h10 +5.30% vs autoregression and +3.55% vs anchoring | Independent numerical/public-payload audit passed; 9 favorable intervals, 7 inconclusive, 2 unfavorable point estimates. Context adds no clear benefit. Six-run component follow-up reviewed (83 tests), registered and submitted: jobs 200443–200448; two GPUs now active on ws-l1-006/ws-l5-004, CPU finalizer 200449. Figures 23–25 reviewed in the 64-page draft |
