...
| Spatial architecture revision | Complete: 15 full 30-epoch runs, 15 exact offline reloads, 16 paired comparisons; native h10 +5.30% vs autoregression and +3.55% vs anchoring | Independent numerical/public-payload audit passed; 9 favorable intervals, 7 inconclusive, 2 unfavorable point estimates. Context adds no clear benefit. Six-run component follow-up reviewed (83 tests), registered and submitted: jobs 200443–200448; two GPUs now active on ws-l1-006/ws-l5-004, CPU finalizer 200449. Version comparison, task, architecture and qualitative figures are integrated in the 67-page draft; four follow-up runs complete and final two seeds running at07:15UTC |
| Additional real benchmark | Public IWS manipulation download and metadata audit complete; 3,489 train / 60 validation recordings. Full PushT feature cache validated: 600 recordings /119,887 frames (480 train/120 internal development) | Single-observation predictor protocol designed; training/evaluation not yet run. Official validation payloads remain untouched. Retain upstream horizon-index ambiguity and metadata discrepancies. RLA-WM reproduction requires authorized DINOv3-L access and compatibility repair |
