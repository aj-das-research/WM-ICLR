...
\caption{\textbf{Datasets.} Every forecasting task predicts $K{=}10$ future feature grids from $H{=}3$ observed frames and
the actions. Step: one model time step. Splits are disjoint at the split unit. DINO-WM PushT and Wall use the official
releases and splits.}
\label{tab:datasets}
\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{@{}p{0.14\linewidth}p{0.35\linewidth}ccccc@{}}
\toprule
...
Open-H Hamlyn & dVRK arms on 7 surgical training tasks (knot tying, needle grasp and handover, peg transfer, two suturing tasks, tissue lifting, tissue retraction); scene camera & 708 / 152 / 153 & 0.33\,s & 80-D & episode & CC-BY-4.0 \\
