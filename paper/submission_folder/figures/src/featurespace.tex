...
\begin{scope}[x=0.92cm, y=0.98cm, shift={(-0.62cm,-0.55cm)}]
  ...
  \node[font=\scriptsize, text=addred, anchor=north west, align=left] at (0.95,6.28)
    {additive head (Direct): synthesise\\$\z_{0,\pi(i)}-\z_{0,i}$ from scratch};
  ...
  \node[font=\scriptsize, text=obsblue!85!black, anchor=south west, inner sep=1pt] at ($(pi)+(0.08,0.12)$) {$\z_{0,\pi(i)}$};
