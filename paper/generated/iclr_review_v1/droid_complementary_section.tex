...
Table~\ref{tab:droid-complementary-metrics} in the main paper reports all internal controls, persistence, and four adapted official DINO-WM recipes across the four endpoint metrics.
