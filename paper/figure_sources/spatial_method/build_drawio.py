...
def create():
    ...
    file = ET.Element('mxfile', {'host':'app.diagrams.net','type':'device','version':'24.7.17'})
    ...
    vertex('residual-projection','Rₕ\nLayerNorm + linear',1030,1110,165,100,fill='#FBF2E7',color=OCHRE,font=20)
    vertex('bounded-innovation','Δₕ = tanh(Rₕ)\n|Δₕ| ≤ 1',1250,1110,150,100,fill='#FBF2E7',color=OCHRE,font=21)
