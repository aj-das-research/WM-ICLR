...
Figure~\ref{fig:real-video-data} follows one recorded episode from observed
history and logged commands to future-feature forecasting and withheld-target
scoring. Its camera panel separates the primary view from the transfer test.

\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{generated/editorial/droid_forecast_setup.pdf}
\caption[Recorded-video forecasting setup]{\input{figure_sources/droid_forecast_setup/caption.tex}}
...
\IfFileExists{tables/real_video_results.tex}{
\FloatBarrier
\input{tables/real_video_results.tex}
}{}
...
multiple comparisons. Figure~\ref{fig:real-video-comparison}A relates
...
The separately frozen evaluation on untouched recording sessions is reported
in Section~\ref{app:fresh-real-video}; it does not replace the original test
results or change the development status of this validation comparison.

\input{generated/real_video/residual_calibration.tex}
